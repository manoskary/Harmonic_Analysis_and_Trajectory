...
while isValidList == [] :
	composer = input("The Composer's name wasn't valid enter another composer : ")
	isValidList = corpus.getComposer(composer)

imageDirectory = input("Enter the directory to save the plots : ")
isDirectory = os.path.isdir(imageDirectory)
while not isDirectory :
	imageDirectory = input("The directory wasn't valid enter another directory : ")
	isDirectory = os.path.isdir(imageDirectory)
...
CentralitiesScatterPlot(Bach, Directory, Composer, 'Mix3', imageDirectory, "Bach", directorystyle, composer)
CentralitiesScatterPlot(Bach, Directory, Composer, 'Mix4', imageDirectory, "Bach", directorystyle, composer)
CentralitiesScatterPlot(Bach, Directory, Composer, 'Eigenvalues', imageDirectory, "Bach", directorystyle, composer)
CentralitiesScatterPlot(Bach, Directory, Composer, 'Closeness', imageDirectory, "Bach", directorystyle, composer)
...
print("Comparison between " + composer + "and " + directory + " : ", twoDictsDistCompare(Composer, Directory))
